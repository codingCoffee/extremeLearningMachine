...
if Elm_Type == REGRESSION
    TrainingAccuracy=sqrt(meansq(T - Y))   %OCTAVE%%   Calculate training accuracy (RMSE) for regression case
    %TrainingAccuracy=sqrt(mse(T - Y)       %MATLAB%%   Calculate training accuracy (RMSE) for regression case
end
clear H;
...
if Elm_Type == REGRESSION
    TestingAccuracy=sqrt(meansq(TV.T - TY))    %OCTAVE%%   Calculate testing accuracy (RMSE) for regression case
    %TestingAccuracy=sqrt(mse(TV.T - TY))       %MATLAB%%   Calculate testing accuracy (RMSE) for regression case            
end
